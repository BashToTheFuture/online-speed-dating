<template>
    <div class="row">
        ...
        <div class="container-fluid col-xs-5 col-xs-offset-1 jumbotron" id="binfo">
            <h3>Basic info</h3>
            <div class="form-group col-xs-12" v-for="(info, key) in basic">
                <div class="col-xs-2 col-xs-offset-2" id="key"> {{key}} :</div>
        ...
        <div class="container-fluid col-xs-5 jumbotron" id="pinfo">
            <h3>Personal info</h3>
            <div class="form-group col-xs-10 col-xs-offset-2">
                <div class="col-xs-3 col-xs-offset-2" id="kids">Divorced: </div>
                <div>
                ...
                <br>
                <div class="col-xs-3 col-xs-offset-2" id="kids">Number of kids: </div>
                <input type="number" min="0" max="15" placeholder="0" v-model="personal.kids" required>
                <br>
                <div class="col-xs-3 col-xs-offset-2" id="kids">Description: </div>
                <br>
        ...
        <div class="container-fluid col-xs-10 col-xs-offset-1 jumbotron" id="ints">
            <h3>Interests</h3>
